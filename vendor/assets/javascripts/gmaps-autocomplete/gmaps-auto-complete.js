...
(function() {
  var GmapsCompleter, GmapsCompleterDefaultAssist, GmapsErrorHandler, GmapsUI,
  ...
  GmapsCompleter = (function() {
    ...
    GmapsCompleter.prototype.fields = {
    ...
    GmapsCompleter.prototype.addMapListeners = function(marker, map) {
      ...
      google.maps.event.addListener(marker, 'dragend', function() {
        return self.lookup('latLng', marker.getPosition());
      });
      return google.maps.event.addListener(map, 'click', function(event) {
        marker.setPosition(event.latLng);
        return self.lookup('latLng', event.latLng);
      });
    };
  ...
  GmapsUI = (function() {
    ...
    GmapsUI.prototype.updateMap = function(geometry) {
      var map, marker;
      map = this.map;
      marker = this.marker;
      if (map) {
    ...
    GmapsUI.prototype.updateUI = function(address, latLng, geocoderResponse) {
    ...
    GmapsUI.prototype.positionOutputter = function(latLng) {
  ...
  GmapsErrorHandler = (function() {
    function GmapsErrorHandler() {}

    GmapsErrorHandler.prototype.geocodeErrorMsg = function() {
      return "Sorry, something went wrong. Try again!";
    };

    GmapsErrorHandler.prototype.invalidAddressMsg = function(value) {
      return "Sorry! We couldn't find " + value + ". Try a different search term, or click the map.";
    };

    GmapsErrorHandler.prototype.noAddressFoundMsg = function() {
      return "Woah... that's pretty remote! You're going to have to manually enter a place name.";
    };

    return GmapsErrorHandler;
...
//# sourceMappingURL=gmaps-auto-complete.js.map
